...
""")
        ...
        if menu == "1":
                while True:
                        ...
                        for i in range(1, 300):
                                ...
                                print(f"{Fore.GREEN}{Style.BRIGHT}{bot}{Style.RESET_ALL} đã đặt cược {Fore.RED}{Style.BRIGHT}{dat_cuoc}{Style.RESET_ALL} với số tiền cược là {Fore.YELLOW}{Style.BRIGHT}{tien_cuoc}{duoi_tien}${Style.RESET_ALL}")
                                time.sleep(0.10)
                        print("")
        ...
        if menu == "2":
                ...
                while True:
                        ...
                        print(f"{Fore.GREEN}{Style.BRIGHT}{bot}{Style.RESET_ALL} : {chat}")
                        time.sleep(0.30)
        ...
        if menu == "3":
                while True:
                        ...
                        for bot in user_list:
                                ...
                                print(f"{Fore.GREEN}{Style.BRIGHT}{bot}{Style.RESET_ALL} Số Dư Tài Khoản Còn : {Fore.YELLOW}{Style.BRIGHT}{xu}{duoi_xu}${Style.RESET_ALL},")
                        time.sleep(50)
